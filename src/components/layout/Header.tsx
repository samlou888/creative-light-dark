            ...
            <div className="flex items-center">
              <Popover>
                <PopoverTrigger asChild>
                  <button
                    className={`w-9 h-9 flex items-center justify-center rounded-lg hover:bg-primary/5`}
                ...
                >
                  <div className="flex flex-col w-full">
                    <button 
                      ...
                      className={`flex items-center gap-2 px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 w-full text-left ${language === 'de' ? 'bg-primary/10 text-primary' : ''}`}
                    >
                      <img 
                    ...
                    <button 
                      ...
                      className={`flex items-center gap-2 px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 w-full text-left ${language === 'en' ? 'bg-primary/10 text-primary' : ''}`}
                    >
                      <img 
                    ...
                    <button 
                      ...
                      className={`flex items-center gap-2 px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 w-full text-left ${language === 'fr' ? 'bg-primary/10 text-primary' : ''}`}
                    >
                      <img 
