          ...
          <div className="space-y-8">
            ...
            <p className="text-xl text-muted-foreground max-w-lg opacity-0 animate-slide-up-fade" style={{ animationDelay: "0.3s" }}>
              {mode === 'academy' 
                ...
                : "Wir bauen smarte Automationen, die deinen Alltag vereinfachen, dein Team entlasten und dein Business skalieren. Von Lohnauszahlungen bis Rechnungsversand – wir automatisieren, um dir Zeit und Kosten zu sparen."
              }
            </p>
