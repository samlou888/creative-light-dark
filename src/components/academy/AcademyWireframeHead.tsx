...
interface AcademyWireframeHeadProps {
  className?: string;
}

const AcademyWireframeHead: React.FC<AcademyWireframeHeadProps> = memo(({ className = '' }) => {
...
AcademyWireframeHead.displayName = 'AcademyWireframeHead';

export default AcademyWireframeHead;
